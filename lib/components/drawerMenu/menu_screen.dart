...
// import 'package:halen_supper_app/components/drawerMenu/drawer_scaffold.dart';
// import 'package:halen_supper_app/enums/direction_enum.dart';
// import 'package:halen_supper_app/enums/menu_enum.dart';
...
//     Key? key,
//   })  : assert((child != null && menuWidget == null && itemBuilder == null) ||
//             (child == null && menuWidget != null)),
...
//   Widget createMenuItems(HalenMenuController menuController) {
...
//   Widget createDrawer(HalenMenuController menuController) {
//     List<Widget> widgets = [];
...
//           )));
//     }
//     HalenMenuController controller = DrawerScaffold.currentController(context);
//     return Transform(
...
//         builder: (BuildContext context, HalenMenuController menuController) {
