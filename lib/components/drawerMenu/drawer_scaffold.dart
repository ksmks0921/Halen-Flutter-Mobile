...
//     BuildContext context, HalenMenuController menuController);
...
//   static HalenMenuController currentController(BuildContext context,
//       {bool nullOk = true}) {
...
//       ErrorSummary(
//           '_SideDrawerState.of() called with a context that does not contain a HalenMenuController.'),
...
//   List<HalenMenuController>? menuControllers;
...
//   HalenMenuController createController(SideDrawer d) {
//     HalenMenuController controller = dcreateController(
//       context,
//       d,
//       this,
//       (value) {
...
//   HalenMenuController dcreateController(BuildContext context, SideDrawer d,
//       TickerProvider vsync, Function(double) onAnimated) {
//     HalenMenuController controller = HalenMenuController(
//       d,
//       onAnimated,
//       context: context,
//       vsync: vsync,
...
//               HalenMenuController menuController =
...
//   HalenMenuController get _controller => menuControllers![focusDrawerIndex];
// }
...
//   HalenMenuController getMenuController(BuildContext context,
...
// class HalenMenuController extends ChangeNotifier {
...
//   HalenMenuController(this._drawer, this.onAnimated,
...
//   List<HalenMenuController>? _menuControllers;
