...
class RideHistoryDetailsScreen extends StatefulWidget {
  const RideHistoryDetailsScreen({Key? key, required this.orderData})
      : super(key: key);
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Flexible(
                                    child: Text(
                                  "Ride to - ${widget.orderData["ride_to_location"]}",
                                  style: TextStyle(
                                      fontSize: 24.w,
                            ...
                            RideCompleteOrCanceledItemsRow(
                            ...
                            Text(
                              widget.orderData["ride_from_location"],
                              style: TextStyle(
                                  fontSize: 18.w,
                            ...
                            Text(
                              widget.orderData["ride_to_location"],
                              style: TextStyle(
                                  fontSize: 18.w,
                                  fontWeight: FontWeight.w400,
                                  color: Colors.black),
...
class RideCompleteOrCanceledItemsRow extends StatelessWidget {
  const RideCompleteOrCanceledItemsRow({Key? key, required this.orderData})
      : super(key: key);
  final Map orderData;
