...
class ConfirmCheckout extends ConsumerWidget {
  ...
  navigateAwayPress(BuildContext context, WidgetRef ref, String dest) {
    ref.read(shopOrderProv.notifier).clearCart();
    if (dest == "home") {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    for (GOrder eo in orders) {
      builtConfirmVendorItems.add(RetailCheckoutConfirmVendorItemsList(
        orderData: eo,
      ));
    }
  ...
  // Widget buildMultipleProductConfirms(
  //     BuildContext context, int count, List<ShopProduct> products) {
  //   return Column(
  //     children: List.generate(
  //         count, (index) => buildProductConfirm(context, products[index])),
  //   );
  // }
}

class RetailCheckoutConfirmVendorItemsList extends StatelessWidget {
  const RetailCheckoutConfirmVendorItemsList(
