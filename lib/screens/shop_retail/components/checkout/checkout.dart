...
import 'package:halen_customer_app/screens/shop_retail/components/checkout/confirm_checkout.dart';
...
class CheckoutState extends ConsumerState<Checkout> {
  ...
  Widget build(BuildContext context) {
    List<GOrder> orders = ref.watch(shopOrderProv);
