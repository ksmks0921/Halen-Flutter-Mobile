...
import 'package:halen_customer_app/screens/shop_retail/components/checkout/checkout.dart';
...
class RetailCart extends ConsumerWidget {
  const RetailCart({
    Key? key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    List<ShopOrder> sShopOrder = ref.watch(shopOrderProv);

    List<Widget> buildSeparatedVendorProducts = [];

    double calcDeliveryFeeForOrderRes = calcDeliveryFeeForOrder(sShopOrder);
    double calcOrderSubtotalRes = calcOrderSubtotal(sShopOrder);
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return sod.items.isEmpty
              ...
              : CartProduct(
                  ...
                  vendor: sod.vendor as ShopVendor,
